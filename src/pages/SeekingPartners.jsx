          ...
          <FadeIn delay={0.1}>
            <div className="grid grid-cols-1 md:grid-cols-3 gap-0 border border-slate-700 rounded-2xl overflow-hidden mb-12">
              <div className="border-b md:border-b-0 md:border-r border-slate-700">
                <ProblemStat number="$10.5T" label="Annual cybercrime cost by 2025" sub="Up from $3T in 2015 — World Economic Forum" />
              </div>
              <div className="border-b md:border-b-0 md:border-r border-slate-700">
            ...
            <FadeIn delay={0.1}>
              <PillarCard
                ...
                points={[
                  ...
                  'No breach has ever occurred against a fully deployed moving-target system',
